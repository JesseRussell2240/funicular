...
def video_feed()
    ...
    return Response(camera_stream.gen_frames(), mimetype='multipartx-mixed-replace; boundary=frame')
...
def control()
    ...
    print(fReceived control command {direction})
    # Here, you can interface with ROS to send control commands for manual driving
    # rospy.Publisher('carmanual_control', String, queue_size=10).publish(direction)
    return 'OK', 200
